...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  body{font-family:'JetBrains Mono',monospace;background:#0a0a0f;color:#e0e0e0;display:flex;align-items:center;justify-content:center;min-height:100vh;overflow:hidden}
  ...
  .logo h1{font-family:'Orbitron',monospace;font-size:28px;font-weight:900;letter-spacing:.15em;text-transform:uppercase;color:#00ff88;text-shadow:0 0 20px rgba(0,255,136,.4),-1px 0 #ff00ff,1px 0 #00d4ff}
  ...
  input{width:100%;padding:12px 16px;padding-left:24px;background:rgba(10,10,15,.9);border:1px solid #2a2a3a;color:#00ff88;font-family:'JetBrains Mono',monospace;font-size:14px;outline:none;transition:all .2s;letter-spacing:.03em;clip-path:polygon(0 4px,4px 0,calc(100% - 4px) 0,100% 4px,100% calc(100% - 4px),calc(100% - 4px) 100%,4px 100%,0 calc(100% - 4px))}
  input:focus{border-color:#00ff88;box-shadow:0 0 5px #00ff88,0 0 15px rgba(0,255,136,.3)}
  input::placeholder{color:#4a4a5a}
  button{width:100%;padding:14px;background:#00ff88;color:#0a0a0f;border:none;font-family:'Orbitron',monospace;font-size:13px;font-weight:700;cursor:pointer;transition:all .15s;text-transform:uppercase;letter-spacing:.15em;clip-path:polygon(0 4px,4px 0,calc(100% - 4px) 0,100% 4px,100% calc(100% - 4px),calc(100% - 4px) 100%,4px 100%,0 calc(100% - 4px))}
